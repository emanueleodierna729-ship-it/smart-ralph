...
NOTES = [
    ...
    ["", ""],
    ["LEVA CHIAVE", "La marca decide il prezzo: premium (Miller, ESAB, Lincoln, Fronius, Cebora, Kemppi) = offerte buone; no-name = offerte basse."],
    ["", ""],
    ["LE TUE MARCHE - Kemppi", "PREMIUM. Tra i marchi per cui i compratori pagano DI PIU sull'usato (insieme a ESAB, Fronius, Miller, Lincoln). Alta domanda in tutta Europa. Westermans ha una pagina dedicata all'acquisto/vendita di Kemppi MIG usate -> per i lotti con Kemppi e il canale n.1 (prezzo migliore + ritiro UE)."],
    ["LE TUE MARCHE - Sincosald", "Produttore italiano dal 1950 (NE Milano), qualita medio-alta (serie Evolution/Novamig). Si rivende bene in ITALIA: meglio gli intermediari italiani che conoscono il brand (Sigma, Eurosald). All'estero e meno riconosciuto -> valore inferiore rispetto a Kemppi."],
    ["STRATEGIA PER MARCA", "Lotti con Kemppi/ESAB/Miller -> Westermans (export, paga di piu). Lotti con Sincosald/marche italiane -> intermediari IT del Nord (Sigma/Eurosald). Meglio mandare a entrambi e confrontare le offerte."],
